...
/*  Copyright 2008-2017  Hans Matzen  (email : webmaster at tuxlog dot de)
...
function wpg_add_menus()
{
  ...
  add_submenu_page( $PPATH."wpg-admin.php", __('Mail',"wp-greet"), __('Mail', "wp-greet"), 'manage_options', $PPATH."wpg-admin-mail.php", "wpg_admin_mail") ;
