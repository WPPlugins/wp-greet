...
function wpg_admin_form() 
{
  ...
  if (isset($_POST['info_update'])) {
    ...
    $thispageoptions = array(
	    ...
	    "wp-greet-default-title",   "wp-greet-imagewidth",
	    "wp-greet-logging",      	"wp-greet-gallery",
		"wp-greet-formpage",     	"wp-greet-smilies",
		"wp-greet-stampimage",   	"wp-greet-stamppercent", 
		"wp-greet-onlinecard",   	"wp-greet-ocduration",   
		"wp-greet-octext",	 	    "wp-greet-logdays",   
		"wp-greet-carddays",        "wp-greet-show-ngg-desc",
		"wp-greet-future-send",     "wp-greet-multi-recipients", 
		"wp-greet-tinymce", 	    "wp-greet-offerresend",
	    "wp-greet-external-link",	"wp-greet-disable-css",
	    "wp-greet-use-wpml-lang",	"wp-greet-sent-message",
	    "wp-greet-confirm-sent-message",
	    "wp-greet-audio",			"wp-greet-offer-stamps",
...
?>
         ...
         <tr class="tr-admin">
         <th scope="row">&nbsp;</th>
         <td><input type="checkbox" name="wp-greet-multi-recipients" id="wp-greet-multi-recipients" value="1" <?php if ($wpg_options['wp-greet-multi-recipients']=="1") echo "checked=\"checked\""?> onclick="wechsle_multiuser();" /> <b><?php echo __('Allow more than one recipient',"wp-greet")?></b></td>
	     </tr>
	       
	     <tr class="tr-admin">
         <th scope="row">&nbsp;</th>
         <td><input type="checkbox" name="wp-greet-multi-recipients-bcc" id="wp-greet-multi-recipients-bcc" value="1" <?php if ($wpg_options['wp-greet-multi-recipients-bcc']=="1") echo "checked=\"checked\""?> /> <b><?php echo __('Allow Bcc for multiple recipients',"wp-greet")?></b></td>
	     </tr>
...
?>
        ...
        <td><textarea name='wp-greet-sent-message' cols='50'rows='4'><?php echo $wpg_options['wp-greet-sent-message']; ?></textarea>
         <img src="<?php echo site_url(PLUGINDIR . "/wp-greet/tooltip_icon.png");?>" alt="tooltip" title='<?php _e("HTML allowed, use %sender% for sendername, %sendermail% for sender email-address, %receiver% for receiver name","wp-greet");?>'/>
        </td>
        </tr>
        ...
        <td><textarea name='wp-greet-confirm-sent-message' cols='50'rows='4'><?php echo $wpg_options['wp-greet-confirm-sent-message']; ?></textarea>
         <img src="<?php echo site_url(PLUGINDIR . "/wp-greet/tooltip_icon.png");?>" alt="tooltip" title='<?php _e("HTML allowed, use %sender% for sendername, %sendermail% for sender email-address, %receiver% for receiver name","wp-greet");?>'/>
          ...
          <tr class="tr-admin">
          <th scope="row">&nbsp;</th>
          <td><input type="checkbox" name="wp-greet-offer-stamps"  id="wp-greet-offer-stamps" value="1" <?php if ($wpg_options['wp-greet-offer-stamps']=="1") echo "checked=\"checked\""?> /> <b><?php echo __('offer different stamps from the stamps directory',"wp-greet")?></b></td>
          </tr>
          
          <tr class="tr-admin">
          <th scope="row">&nbsp;</th>
          <td><input type="checkbox" name="wp-greet-offer-stamps-buddypress"  id="wp-greet-offer-stamps-buddypress" value="1" <?php if ($wpg_options['wp-greet-offer-stamps-buddypress']=="1") echo "checked=\"checked\""?> /> <b><?php echo __('offer BuddyPress group logo as stamp',"wp-greet")?></b></td>
          <td><input type="checkbox" name="wp-greet-offer-stamps-buddypress-adminonly"  id="wp-greet-offer-stamps-buddypress-adminonly" value="1" <?php if ($wpg_options['wp-greet-offer-stamps-buddypress-adminonly']=="1") echo "checked=\"checked\""?> /> <b><?php echo __('for BuddyPress group admin only',"wp-greet")?></b></td>
          </tr>
...
?>
		  ...
		  <tr class="tr-admin">
          <th scope="row">&nbsp;</th>
          <td><input type="checkbox" name="wp-greet-audio"  id="wp-greet-audio" value="1" <?php if ($wpg_options['wp-greet-audio']=="1") echo "checked=\"checked\""?> /> <b><?php echo __('enable background music for cards',"wp-greet")?></b></td>
          </tr>
          ...
          <tr class="tr-admin"> 
          <th scope="row">&nbsp;</th>
          <td><input type="checkbox" name="wp-greet-logging"  id="wp-greet-logging" value="1" <?php if ($wpg_options['wp-greet-logging']=="1") echo "checked=\"checked\""?> onclick="wechsle_logging();"/> <b><?php echo __('enable logging',"wp-greet")?></b></td>
          </tr>
